            ...
            <div className="rounded-[18px] overflow-hidden" style={{ border: "1px solid hsl(217,32%,16%)" }}>
              ...
              <div className="grid grid-cols-3 text-center">
                <div className="py-5 px-2" style={{ borderRight: "1px solid hsl(217,32%,12%)" }}>
                  <p className="font-bold text-[25px] md:text-2xl" style={{ color: "hsl(215,20%,40%)" }}>3 000–8 000€</p>
                ...
                <div className="py-5 px-2" style={{ background: "hsl(217,91%,60%,0.05)", borderLeft: "1px solid hsl(217,91%,60%,0.20)", borderRight: "1px solid hsl(217,91%,60%,0.20)" }}>
                  <p className="font-bold text-[25px] md:text-2xl" style={{ background: "linear-gradient(110deg,hsl(217,91%,66%),hsl(263,90%,74%))", WebkitBackgroundClip: "text", backgroundClip: "text", WebkitTextFillColor: "transparent" }}>dès 890€</p>
                ...
                <div className="py-5 px-2" style={{ borderLeft: "1px solid hsl(217,32%,12%)" }}>
                  <p className="font-bold text-[25px] md:text-2xl" style={{ color: "hsl(215,20%,40%)" }}>1 000–4 000€</p>
