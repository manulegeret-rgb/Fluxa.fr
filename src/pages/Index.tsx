  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* ═══════════════════════════════════════════
          NOS SITES (#services)
      ═══════════════════════════════════════════ */}
      <section id="services" className="pt-[50px] pb-[20px] bg-background">
      ...
      ═══════════════════════════════════════════ */}
      <section id="comment-ca-marche" style={{ scrollMarginTop: "100px" }}>
        <CommentCaMarche />
      </section>
      ...
      {/* ═══════════════════════════════════════════
          PRICING (#pricing)
      ═══════════════════════════════════════════ */}
      <section id="pricing" className="pt-[50px] pb-[20px] bg-background scroll-mt-28">
      ...
      {/* ═══════════════════════════════════════════
          CONTACT (#infos)
      ═══════════════════════════════════════════ */}
      <section id="infos" className="pt-[50px] pb-[20px] bg-background relative overflow-hidden scroll-mt-28">
        {/* Glow blob centré */}
      ...
      ═══════════════════════════════════════════ */}
      <section id="pourquoi-choisir-fluxa" className="pt-[50px] pb-[20px] bg-background">
