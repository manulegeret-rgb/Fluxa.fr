...
Merci !`
  ...
  // ========= CONTRÔLE DU SHEET MOBILE (fermeture auto au clic sur un lien)
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
          ...
          <div className="md:hidden grid grid-cols-3 items-center h-20">
            ...
            <div className="flex">
              <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
                ...
                {/* onClickCapture : ferme le menu si on clique un <a> à l’intérieur */}
                <SheetContent
                  side="left"
      ...
      {/* ================= AUTOMATIONS ================= */}
      <section id="automations" className="scroll-mt-24 md:scroll-mt-40">
        <Automations />
      </section>

      {/* ================= PRICING ================= */}
      <section id="pricing" className="py-24 bg-background scroll-mt-24 md:scroll-mt-40">
        <div className="container mx-auto px-6">
          <div className="text-center space-y-6 mb-16">
      ...
      {/* ================= CTA / INFOS (formulaire) ================= */}
        <section
  id="infos"
  className="pt-0 pb-16 scroll-mt-24 md:scroll-mt-40 bg-gradient-to-b from-background via-[hsl(217,40%,8%)] to-background relative overflow-hidden"
>
...
>
      ...
      {/* ================= FAQ ================= */}
      <section id="faq" className="scroll-mt-24 md:scroll-mt-40">
        <Faq />
      </section>
